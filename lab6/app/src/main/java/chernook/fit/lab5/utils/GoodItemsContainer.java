...
import chernook.fit.lab5.listener.GoodsItemsContainerListener;
...
public class GoodItemsContainer {
    ...
    private static List<GoodsItemsContainerListener> listeners = new ArrayList<>();

    private static void handleListeners() {
        for (GoodsItemsContainerListener listener : listeners) {
    ...
    public static List<GoodsItem> getGoodsItemsListByPattern() {
